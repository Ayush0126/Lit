...
export default function Privacy() {
  return (
    <div className="privacy-container no-scroll fixed-layout">
      <h1 className="privacy-title">Privacy Policy</h1>

      <div className="privacy-split-layout no-scroll">
        <div className="privacy-column">
          <section className="privacy-section">  
            <h2 className="privacy-heading">1. Introduction</h2>
            <p className="privacy-text small-font">
          ...
          <section className="privacy-section">
            ...
            <ul className="privacy-text small-font">
          ...
          <section className="privacy-section">
            <h2 className="privacy-heading">4. Data Sharing & Disclosure</h2>
            <ul className="privacy-text small-font">
        ...
        <div className="privacy-column">
          ...
          <section className="privacy-section">
            <h2 className="privacy-heading">7. Retention</h2>
            <p className="privacy-text small-font">
